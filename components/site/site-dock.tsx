...
const socialLinks: readonly SocialLink[] = [
  {
    ...
    label: "Канал @nix_ux_view",
    ariaLabel: "Telegram канал @nix_ux_view",
    icon: <TelegramIcon />
  },
  {
    href: "https://dsgners.ru/nixnix",
    label: "Профиль Dsgners",
    ariaLabel: "Профиль на Dsgners",
    icon: <DsgnersIcon />
  },
  {
    href: "https://vc.ru/id4483143",
    label: "Профиль VC.ru",
    ariaLabel: "Профиль на VC.ru",
    icon: <VcRuIcon />
  }
];

export function SiteDock({ className }: SiteDockProps) {
  return (
    <nav
    ...
    >
      ...
      <div className={styles.socialSegment}>
        {socialLinks.map((link) => (
          ...
          >
            <span className={styles.socialTooltip} aria-hidden="true">
              {link.label}
            </span>
