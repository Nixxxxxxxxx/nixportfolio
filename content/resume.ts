      ...
      projects: [
        {
          ...
          bullets: [
            ...
            [
              {
                text: "Доработал внутреннюю дизайн систему. Создал и согласовал внедрение новых компонентов, результат по внутренним метрикам — "
              },
              { text: "X", strong: true }
            ],
            [
              { text: "Результат по сценарию создания курса — " },
              { text: "X", strong: true }
            ],
            [
              { text: "Результат по обращениям в поддержку — " },
              { text: "X", strong: true }
            ]
          ]
        },
